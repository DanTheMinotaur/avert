...
plugin.checkReadableStreams = (obj) => {
    function isReadableStream(o) {
        return o instanceof stream.Readable;
    }
...
plugin.avert = (obj, options, firstPass, secondPass) => {
    ...
    if (cleansed && Object.keys(cleansed).length) {
        let readableStreams;
        readableStreams = plugin.checkReadableStreams(obj);

        cleansed = readableStreams._toSanitize;
        ...
        if (
            readableStreams._readableStreams &&
            Object.keys(readableStreams._readableStreams).length
        ) {
            cleansed = Object.assign(
                cleansed,
                readableStreams._readableStreams
            );
        }
